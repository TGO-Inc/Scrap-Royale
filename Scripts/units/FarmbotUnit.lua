dofile( "$CONTENT_DATA/Scripts/units/unit_util.lua" )
dofile( "$CONTENT_DATA/Scripts/util/Ticker.lua" )
...
dofile( "$CONTENT_DATA/Scripts/units/states/BreachState.lua" )
dofile( "$CONTENT_DATA/Scripts/units/states/CombatAttackState.lua" )
dofile( "$CONTENT_DATA/Scripts/units/states/CombatFollowAttackState.lua" )
dofile( "$CONTENT_DATA/Scripts/survival_loot.lua" )
dofile( "$CONTENT_DATA/Scripts/survival_constants.lua" )
dofile( "$SURVIVAL_DATA/Scripts/util.lua" )
dofile( "$CONTENT_DATA/Scripts/survival_meleeattacks.lua" )
